...
The goal is to keep the client code clean, predictable, and ready for future features such as real race creation, race
lists, teacher race rooms, student screens, SSE, and game rendering.
