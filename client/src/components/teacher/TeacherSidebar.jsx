...
export default function TeacherSidebar() {
    ...
    return (
        <aside className="hidden w-60 flex-none flex-col gap-6 rounded-3xl bg-white/80 p-5 shadow-[0_8px_24px_rgba(27,42,65,0.08)] lg:flex">
            ...
            {sidebarIllustration && (
                <img
                    ...
                    alt=""
                    aria-hidden="true"
                    className="mt-auto max-h-32 w-full border-t border-sky-100 object-contain pt-4 opacity-90"
                />
            )}
        </aside>
    );
