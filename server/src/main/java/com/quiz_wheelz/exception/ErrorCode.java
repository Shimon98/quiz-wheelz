...
public enum ErrorCode {
    ...
    QUESTION_NOT_FOUND_FOR_PLAYER(3020, ErrorMessages.QUESTION_NOT_FOUND_FOR_PLAYER, HttpStatus.NOT_FOUND),
    QUESTION_NOT_ACTIVE(3021, ErrorMessages.QUESTION_NOT_ACTIVE, HttpStatus.CONFLICT),
    QUESTION_EXPIRED(3022, ErrorMessages.QUESTION_EXPIRED, HttpStatus.CONFLICT),
    QUESTION_CHOICE_NOT_FOUND(3023, ErrorMessages.QUESTION_CHOICE_NOT_FOUND, HttpStatus.NOT_FOUND),
    INVALID_ANSWER_SUBMISSION(3024, ErrorMessages.INVALID_ANSWER_SUBMISSION, HttpStatus.BAD_REQUEST),
    RACE_TOTAL_DISTANCE_MISSING(3025, ErrorMessages.RACE_TOTAL_DISTANCE_MISSING, HttpStatus.INTERNAL_SERVER_ERROR),
    RACE_PLAYER_RECONNECT_WINDOW_EXPIRED(
            3026,
            ErrorMessages.RACE_PLAYER_RECONNECT_WINDOW_EXPIRED,
            HttpStatus.CONFLICT
    ),
    RACE_PLAYER_RECONNECT_REQUIRED(
            3027,
    ...
    RACE_RESULTS_NOT_AVAILABLE(
            3030,
            ErrorMessages.RACE_RESULTS_NOT_AVAILABLE,
            HttpStatus.CONFLICT
    ),
