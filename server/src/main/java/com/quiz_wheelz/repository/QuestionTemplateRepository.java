...
public interface QuestionTemplateRepository extends JpaRepository<QuestionTemplate, Long> {
    ...
    List<QuestionTemplate> findBySubjectAndDifficultyAndActiveTrueOrderByIdAsc(
            Subject subject,
            Difficulty difficulty
    );
    ...
    List<QuestionTemplate> findBySubjectAndTypeAndDifficultyAndGenerationPatternAndActiveTrueOrderByIdAsc(
            Subject subject,
            QuestionType type,
            Difficulty difficulty,
